'''
    JAX implementation of Graph attention Networks (https://arxiv.org/abs/1710.10903) based on https://github.com/gcucurull/jax-gat/blob/master/models.py

'''

# TODO Remodel to Hk form for integratability
